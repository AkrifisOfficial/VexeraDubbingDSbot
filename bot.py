...
intents.members = True  # Для проверки ролей пользователей
...
def is_admin(interaction: discord.Interaction) -> bool:
    ...
    # Если ADMIN_ROLE_ID не установлен, разрешаем только владельцу сервера
...
async def check_admin(interaction: discord.Interaction):
    try:
        await interaction.response.send_message(
            "✅ У вас есть права администратора бота!",
            ephemeral=True
        )
    except Exception as e:
